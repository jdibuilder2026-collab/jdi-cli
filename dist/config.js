...
export function getConfig() {
    ...
    if (!config) {
        throw new Error('JDI가 설정되지 않았습니다. `jdi login` 을 먼저 실행하세요.');
    }
    return config;
}
/**
 ...
 */
export function setupClaudeBypass(apiKey) {
    ...
    const customApiKeyResponses = existing.customApiKeyResponses || {
        approved: [],
        rejected: [],
    };
